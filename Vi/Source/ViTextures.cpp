...
bool viutil::loadImageFromFile(ViEngine& engine, const char* file, AllocatedImage & outImage) {
    ...
    VkImageCreateInfo dimg_info = viinit::imageCreateInfo(image_format, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT, imageExtent);
    ...
    vmaCreateImage(engine.allocator, &dimg_info, &dimg_allocinfo, &newImage.image, &newImage.allocation, nullptr);
